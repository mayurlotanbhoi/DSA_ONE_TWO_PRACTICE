public class Cool_And_Hot_subarray {
 static int Happy(int arr[], int n){
     int coolsun = 0;
     int maxCool = 0;
     ...
     for(int j=0; j<n; j++){
         ...
         if(hotSum > 0){
             ...
             Maxhotsum = Math.min(hotSum,Maxhotsum);
         }
     }
     return maxCool - Maxhotsum;
 }
    public static void main(String[] args) {
        int arr[] = {15, -8, -5, 6, 8, -10};
        int n= arr.length;
        System.out.println(Happy(arr,n));
